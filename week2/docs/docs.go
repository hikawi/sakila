    ...
    "definitions": {
        ...
        "routes.PatchFilmBody": {
            ...
            "properties": {
                ...
                "special_features": {
                    "description": "special_features uses your custom StringSet type (made optional via the pointer)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "routes.PostFilmBody": {
            ...
            "properties": {
                ...
                "rental_duration": {
                    "description": "rental_duration is NOT NULL and has a default, but still required for clarity",
                    "type": "integer",
                    "minimum": 1
                },
                "rental_rate": {
